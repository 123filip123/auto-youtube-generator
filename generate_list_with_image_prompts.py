...
def generate_list_with_image_prompts(prompt_topic: str):
    num_items: int = 1
    ...
    filename = f"{LIST_OUTPUT_DIR}/list_items_with_prompts.json"
...
if __name__ == "__main__":
    ...
    result = generate_list_with_image_prompts(topic)
    print("\nGenerated Items with Image Prompts:\n")
    print(result)
